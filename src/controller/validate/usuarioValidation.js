const {validarCampo} = require('../controller')
...
const validateUsuario = (dados) => {
    ...
    if (!validarCampo(senha)) {
        ...
        return {status: false, mensagem: 'ERRO, senha precisa ter no mínimo 8 dígitos!'}
    } else if (senha.length > 20){
        return {status: false, mensagem: 'ERRO, senha pode ter no máximo 20 dígitos!'}
    }
